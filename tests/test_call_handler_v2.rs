...
const COMMIT_HANDLER_V2_DISCRIMINATOR: [u8; 4] = [1, 0, 3, 0];
const UNDELEGATE_HANDLER_V2_DISCRIMINATOR: [u8; 4] = [1, 0, 4, 0];
...
async fn test_finalize_call_handler_v2() {
    ...
    let call_handler_v2_ix = dlp::instruction_builder::call_handler_v2(
        validator.pubkey(),
        DELEGATED_PDA_OWNER_ID, // destination program
        DELEGATED_PDA_OWNER_ID, // source program
        ...
        CallHandlerArgs {
            ...
            data: [
                COMMIT_HANDLER_V2_DISCRIMINATOR.to_vec(),
                to_vec(&PRIZE).unwrap(),
            ]
            .concat(),
        },
    ...
    let tx = Transaction::new_signed_with_payer(
        &[finalize_ix, call_handler_v2_ix],
...
/// Test call_handler_v2 in undelegate context
#[tokio::test]
async fn test_undelegate_call_handler_v2() {
    const PRIZE: u64 = LAMPORTS_PER_SOL / 1000;
    ...
    let call_handler_v2_ix = dlp::instruction_builder::call_handler_v2(
        ...
        CallHandlerArgs {
            escrow_index: 2, // undelegated escrow index
            data: [
                UNDELEGATE_HANDLER_V2_DISCRIMINATOR.to_vec(),
                to_vec(&PRIZE).unwrap(),
            ]
            .concat(),
        },
    ...
    let tx = Transaction::new_signed_with_payer(
        &[finalize_ix, undelegate_ix, call_handler_v2_ix],
        Some(&validator.pubkey()),
        &[&validator],
        blockhash,
    );
...
/// Testing call_handler_v2 in finalize context with invalid escrow
#[tokio::test]
async fn test_finalize_invalid_escrow_call_handler_v2() {
    // Setup
    ...
    let call_handler_v2_ix = dlp::instruction_builder::call_handler_v2(
        ...
        CallHandlerArgs {
            escrow_index: 0,
            data: COMMIT_HANDLER_V2_DISCRIMINATOR.to_vec(),
        },
    );
    let tx = Transaction::new_signed_with_payer(
        &[finalize_ix, call_handler_v2_ix],
...
#[tokio::test]
async fn test_undelegate_invalid_escrow_call_handler_v2() {
    const PRIZE: u64 = LAMPORTS_PER_SOL / 1000;
    ...
    let finalize_ix = dlp::instruction_builder::finalize(authority.pubkey(), DELEGATED_PDA_ID);
    let finalize_call_handler_v2_ix = dlp::instruction_builder::call_handler_v2(
        authority.pubkey(),
        ...
        CallHandlerArgs {
            escrow_index: 0,
            data: UNDELEGATE_HANDLER_V2_DISCRIMINATOR.to_vec(),
        },
    );
    ...
    let undelegate_call_handler_v2_ix = dlp::instruction_builder::call_handler_v2(
        authority.pubkey(),
        DELEGATED_PDA_OWNER_ID, // handler program
        DELEGATED_PDA_OWNER_ID, // source program
        DELEGATED_PDA_ID,
